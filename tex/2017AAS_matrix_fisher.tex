...
\centerline{
	\subcaptionbox{ Attitude estimation error ($\mathrm{deg}$) }{\hspace*{0.03\columnwidth}
		\includegraphics[height=0.36\columnwidth]{figures/2017AAS_matrix_fisher/TAC16_0_R_est_err}\label{fig:R_est_err_0}\hspace*{0.03\columnwidth}}
	\hfill
	\subcaptionbox{ Uncertainty measured by $\frac{1}{s_i+s_j}$ }{\hspace*{0.03\columnwidth}
		\includegraphics[height=0.36\columnwidth]{figures/2017AAS_matrix_fisher/TAC16_0_s}\label{fig:s_0}\hspace*{0.03\columnwidth}}
}
\caption{first-order (red), unscented (blue)}\label{fig:ES_0}
\end{figure}}
...
\begin{column}{0.5\textwidth}
\begin{figure}\setcounter{subfigure}{0}
\includegraphics[width=\columnwidth]{figures/2017AAS_matrix_fisher/AAS17_1_R_est_err} 
\caption{Attitude estimation error ($\mathrm{deg}$)} \label{fig:ES_0} 
\end{figure}
\end{column}
\end{columns}
}
